...
//  Description   : Count Occurance of given element from linked list.
//  Input         : PNODE first → Pointer to first node
//                  int no      → Data to be count occurance of that data from linked list
//  Output        : Return Count of occurance of given data
//  Author        : Vivek Bhauraj Gautam
//  Date          : 30/12/2025
//
////////////////////////////////////////////////////////////////////////////////////////////////////
...
int main()
{
    ...
    iRet = Frequency(head, 110);

    printf("Occurance of given number in linked list is %d \n",iRet);
