// Q1 - Write a program which Display only even element from linked list.
...
//  Description   : Display even element from linked list.
//  Input         : PNODE first → Pointer to first node
//  Output        : Display even element
//  Author        : Vivek Bhauraj Gautam
//  Date          : 30/12/2025
//
////////////////////////////////////////////////////////////////////////////////////////////////////
...
int main()
{
    ...
    printf("Even element from linked list is :\n");
    DisplayEven(head);
