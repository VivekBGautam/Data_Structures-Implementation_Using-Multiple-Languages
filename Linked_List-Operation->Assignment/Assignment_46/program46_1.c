// Q - Write a program which Display greater number than given number from linked list.
...
//  Description   : Display greater element than given number from linked list.
//  Input         : PNODE first → Pointer to first node
//                  int no      → Input element
//  Output        : Display greater element than X
//  Author        : Vivek Bhauraj Gautam
//  Date          : 30/12/2025
//
////////////////////////////////////////////////////////////////////////////////////////////////////
...
int main()
{
    ...
    printf("Greater element than given element Are : ");
    DisplayGreater(head, 231);
