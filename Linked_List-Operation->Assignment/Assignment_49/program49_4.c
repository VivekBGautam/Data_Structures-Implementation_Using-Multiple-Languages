// Q - Write a program which Count element which are divisible by Five
...
//  Description   : Count element which are divisible by five.
//  Input         : PNODE first → Pointer to first node
//  Output        : Return count of element which divisible by 5
//  Author        : Vivek Bhauraj Gautam
//  Date          : 30/12/2025
//
////////////////////////////////////////////////////////////////////////////////////////////////////
...
int main()
{
    ...
    printf("Count of element which are divisible by Five is : %d \n ",iRet);
