// Q - Write a program which Display element which are divisible by three
...
//  Description   : Display element which are divisible by three.
//  Input         : PNODE first → Pointer to first node
//  Output        : Display element which divisible by 3
//  Author        : Vivek Bhauraj Gautam
//  Date          : 30/12/2025
//
////////////////////////////////////////////////////////////////////////////////////////////////////
...
int main()
{
    ...
    printf("Elelemt vhich are divisible by three is :\n ");
