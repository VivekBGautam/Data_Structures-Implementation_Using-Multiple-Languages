// Q - Write a program which check linked list contain positive number
...
//  Description   : Check weather linked list cotain all positive element.
//  Input         : PNODE first → Pointer to first node
//  Output        : Return true if hole linked list conatin only  positive element
//  Author        : Vivek Bhauraj Gautam
//  Date          : 30/12/2025
//
////////////////////////////////////////////////////////////////////////////////////////////////////
...
int main()
{
    ...
    if(bRet == TRUE)
    {
        printf("Linked List contains only positive elements\n");
    }
    else
    {
        printf("Linked List does NOT contain only positive elements\n");
    }
